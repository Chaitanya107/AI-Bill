...
const deleteProducts = async() => {
    ...
    for (let product of products) {
        const response = await axios.delete(`https://ai-express-pay.onrender.com/product/${product.id}`)
